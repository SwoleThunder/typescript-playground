...
const fancyWords = async (dom: HTMLHeadingElement, string: Array<string>, colors: Array<string>) => {
...
const delay = (fn: Function, ms: number): void => {

    setInterval(fn, Math.floor(Math.random() * 200) + ms * 350)
}

const randomPosition = (dom: HTMLHeadingElement) => {
...
*/
    ...
    const ballColor = (dom: HTMLDivElement) => {
